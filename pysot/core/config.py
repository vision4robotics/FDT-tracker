...
__C.DATASET.VID = CN()
__C.DATASET.VID.ROOT = '../dataset/vid/crop511'
__C.DATASET.VID.ANNO = '..dataset/vid/train.json'
__C.DATASET.VID.FRAME_RANGE = 50 #100
__C.DATASET.VID.NUM_USE = 100000  # repeat until reach NUM_USE

__C.DATASET.YOUTUBEBB = CN()
__C.DATASET.YOUTUBEBB.ROOT = '../dataset/yt_bb/crop511'
__C.DATASET.YOUTUBEBB.ANNO = '../dataset/yt_bb/train.json'
__C.DATASET.YOUTUBEBB.FRAME_RANGE = 3
__C.DATASET.YOUTUBEBB.NUM_USE = -1  # use all not repeat

__C.DATASET.COCO = CN()
__C.DATASET.COCO.ROOT = '../dataset/coco/crop511'
__C.DATASET.COCO.ANNO = '../dataset/coco/train2017.json'
__C.DATASET.COCO.FRAME_RANGE = 1
__C.DATASET.COCO.NUM_USE = -1

__C.DATASET.LaSOT = CN()
__C.DATASET.LaSOT.ROOT = '../dataset/lasot/crop511'         # LaSOT dataset path
__C.DATASET.LaSOT.ANNO = '../dataset/lasot/train.json'
__C.DATASET.LaSOT.FRAME_RANGE = 100
__C.DATASET.LaSOT.NUM_USE = 100000

__C.DATASET.GOT = CN()
__C.DATASET.GOT.ROOT = '../dataset/got10k/crop511'         # GOT dataset path
__C.DATASET.GOT.ANNO = '..dataset/got10k/train.json'
